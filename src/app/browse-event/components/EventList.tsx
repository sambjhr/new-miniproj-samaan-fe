...
const EventList = ({ take = 3, showSearch = true }: Props) => {
  ...
  const { data: events, isPending } = useQuery({
    queryKey: ["events", page, debouncedValue, category, take],
    queryFn: async () => {
  ...
  return (
    <>
      ...
      {/* List */}
      <div className="container mx-auto grid auto-rows-fr grid-cols-1 items-stretch gap-8 p-4 sm:grid-cols-2 lg:grid-cols-3">
        {isPending ? (
